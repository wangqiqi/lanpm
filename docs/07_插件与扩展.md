...
规格：`.cursorGrowth/specs/012-meeting-pro/spec.md`。

验收：`verify:meeting-ux` · `verify:meeting-recording` · `verify:meeting-schedule` · `verify:meeting-plugin` · `verify:meeting-livekit-pro` · `verify:i18n-en`（meeting 键）。
