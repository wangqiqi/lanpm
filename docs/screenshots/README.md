...
- 覆盖：**setup** + **主轴视图**（chat · board · tree · gantt · calendar · cockpit）× 亮/暗；**files · whiteboard · mindmap** 为聊天页 **协作抽屉**态（v1.96+ IA，见 `visualCapture.ts` `COLLAB_DRAWER_SLUGS`）。README 门面同步含 `mindmap.png`。
