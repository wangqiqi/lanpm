...
> **归档日期**：2026-07-31  
> **原因**：全文已融入 `docs/01`–`docs/06` 正文；原 `docs/AI接入.md` 已自 `docs/` 移除。  
> **现行 SSOT**（维护请改下列章节，勿改本归档）：

| 主题 | 位置 |
|------|------|
| 产品原则 · 驾驶舱 · 助手入口 | `docs/01_产品需求文档.md` §12.3–§12.4 |
| 架构 · IPC · 流水线 · 巡检 | `docs/02_技术实现建议.md` §15 |
| 配置 DTO · 本地表 | `docs/03_数据模型与协议草案.md` §3.6–§3.7 |
| Shell 交互与自适应 | `docs/04_交互与UI约定.md` §4.2 |
| `verify:ai-*` 矩阵 | `docs/05_测试与联调发布.md` §1.2.7 |
| 未完成（高级编排等） | `docs/06_ROADMAP.md` §1 |
