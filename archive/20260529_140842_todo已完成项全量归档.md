...
> **迁出日期**：2026-05-29  
> **来源**：根目录 `todo.md` §已完成 + §去重索引（rc.23 前全部 `[x]` 条目）  
> **当前 SSOT**：根目录 [todo.md](../todo.md)（仅保留未完成 `[ ]`）
...
- [x] **B-01** 任务 P2P 同步：`task_patch` LWW + `taskSyncService`（Yjs/`task_crdt` 仍 post-v1.1）
- [x] **B-02** 远端文件 P2P 下载：`file_meta` / `file_pull_request` / `file_chunk` + FilesView「从局域网下载」
...
> 原则摘要见 [plan 概述归档](./20260529_095839_plan概述_SSOT后归档.md) · 手验 [docs/09](../docs/09_视觉手验清单.md)
...
### UX 操作路径与闭环（来源：[UX 审查归档](./20260529_095839_UX操作路径审查_ux.md)）

> 与 [UI 审查归档](./20260529_095839_UI设计审查_ui.md) 互补；断环 **UX-X-*** 优先。与 **UX-F-*** 等同 ID 的条目合并实现即可。
...
### 文档与版本对齐（来源：[评估归档](./20260529_095839_实现文档一致性评估_评估.md) §2、§7、§9）
...
- [x] **DOC-07** `plan.md` 迁出根目录 → [plan 概述归档](./20260529_095839_plan概述_SSOT后归档.md)（2026-05-29）

### PRD 与架构缺口（来源：[评估归档](./20260529_095839_实现文档一致性评估_评估.md) §3、§4）
...
### UI/UX — 功能与交互（来源：[UI 审查归档](./20260529_095839_UI设计审查_ui.md) §3.1、§5）
...
### UI/UX — 国际化（来源：[UI 审查归档](./20260529_095839_UI设计审查_ui.md) §3.2）
...
### UI/UX — 无障碍（来源：[UI 审查归档](./20260529_095839_UI设计审查_ui.md) §3.3）
...
### UI/UX — 视觉与布局（来源：[UI 审查归档](./20260529_095839_UI设计审查_ui.md) §3.4–3.6）
