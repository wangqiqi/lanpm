...
description: >-
  ...
  static CSS/token audit, and tracks todo.md. Use for visual/UI consistency,
...
| 模式 | 触发 | 深度 |
|------|------|------|
| **门禁** | 发版 / RC / `verify:m7` 前 | `verify:visual` + `todo.md` 未完成项 |
...
| 场景 | 动作 |
|------|------|
| 门禁 | 汇报脚本结果 + `todo.md` 勾选建议 |
| 全量审计 | 待办只更新 `todo.md`；若需留档，新建 `archive/audit/visual/YYYYMMDD_HHMMSS_视觉一致性校验.md`（勿在 `docs/`、`.cursor/` 中加链接） |
