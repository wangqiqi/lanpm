...
assert.match(readme, new RegExp('version-' + v), 'README badge must match package.json')
assert.match(readme, new RegExp('Current `' + pkg.version + '`'), 'README current version must match package.json')
assert.match(readmeZh, new RegExp('版本-' + v), 'README.zh-CN badge must match package.json')
assert.match(readmeZh, new RegExp('当前版本 `' + pkg.version + '`'), 'README.zh-CN current version must match package.json')
