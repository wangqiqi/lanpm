...
assert.match(pluginCss, /agileBoardToolbar/)
assert.match(pluginCss, /agileMetricsRow/)
assert.match(pluginCss, /data-plugin-zone='toolbar'/)
...
assert.match(stub, /agile-metrics/)
assert.match(stub, /Popover/)
