...
const doc07 = join(root, 'docs/07_跨平台发版矩阵.md')
assert.ok(existsSync(doc07), 'docs/07_跨平台发版矩阵.md required')
const docBody = readFileSync(doc07, 'utf8')
...
assert.match(feige, /07_跨平台发版矩阵|verify:platform-matrix/)

const nav = readFileSync(join(root, 'docs/00_文档导航.md'), 'utf8')
assert.match(nav, /07_跨平台发版矩阵/)
