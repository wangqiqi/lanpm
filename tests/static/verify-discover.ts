...
assert.match(modal, /discover-wizard-join-guide/)
assert.match(modal, /discover-wizard-back-connect/)
assert.match(modal, /joinRequestGroupLabel/)
assert.match(modal, /pairingConnected/)
