...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.106.3-blue" alt="version" />
...
**Current `1.106.3`** — Free `lanpm.backup` (default on) wraps encrypted group `.lanpm-bundle`. Paid schedule: FS/SS/FF/SF critical path + per-group freeze baseline. Paid agile: remaining-points burndown. Linux `--full` sample + installer smoke. License [AGPL-3.0-or-later](./LICENSE).
