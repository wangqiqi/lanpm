...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.3-blue" alt="version" />
...
**Current `1.78.3`** — Command invoke real handlers; global plugin slots; command palette; offline licenses. License [AGPL-3.0-or-later](./LICENSE).
