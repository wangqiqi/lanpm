...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.103.1-blue" alt="version" />
...
**Current `1.103.1`** — group-tag offline sync, pdf.js preview, minisearch, file_chunk `envelope_bin`. License [AGPL-3.0-or-later](./LICENSE).
