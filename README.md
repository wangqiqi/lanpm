...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.6-blue" alt="version" />
...
**Current `1.78.6`** — Extension API v0.3 (`task.patch` · `board.moveTask`); zone context chat wiring. License [AGPL-3.0-or-later](./LICENSE).
