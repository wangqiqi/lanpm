...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.1-blue" alt="version" />
...
**Current `1.78.1`** — Plugin docs SSOT sync; command palette (Ctrl/Cmd+K), signed offline licenses, contributed-tab nav prefs. License [AGPL-3.0-or-later](./LICENSE).
