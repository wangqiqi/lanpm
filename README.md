...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.106.8-blue" alt="version" />
...
**Current `1.106.8`** — Paid agile: remaining-points burndown + column WIP hints + iteration containers. Paid schedule: freeze baseline + assignee date-overlap hints. Weekly next-week plan + independent monthly template. Free `lanpm.backup` (default on). License [AGPL-3.0-or-later](./LICENSE).
