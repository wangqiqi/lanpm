...
**Current:** `1.10.0` — task calendar (6th BottomNav tab, FullCalendar), gantt sticky header / zoom / center-on-today, plus prior board tags, Presence, nav badges, force-dict tags. **Unreleased → 1.11.0:** collaboration whiteboard (Excalidraw, 7th tab). M0–M7 closed in automation; true-device hand tests still deferred (see [acceptance plan](./docs/06_验收与里程碑计划.md) §2.6). Licensed under [AGPL-3.0-or-later](./LICENSE).
