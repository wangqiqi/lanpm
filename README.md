...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.47.0-blue" alt="version" />
...
**Current `1.47.0`** — Discover pairing panel links to a read-only LAN wiring help modal. License [AGPL-3.0-or-later](./LICENSE).
