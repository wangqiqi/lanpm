...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.2-blue" alt="version" />
...
**Current `1.78.2`** — Global plugin slots (topbar · tab overflow · profile tabs); command palette; offline licenses. License [AGPL-3.0-or-later](./LICENSE).
