...
**Current:** `1.30.0` — **Executive cockpit**: risk-first attention strip, four KPIs (incl. at-risk projects), weekly-report primary CTA, island chrome · plus v1.29 shell vibe. M0–M7 closed in automation; true-device hand tests still deferred ([06_ROADMAP](./docs/06_ROADMAP.md) §4). License: [AGPL-3.0-or-later](./LICENSE).
