...
**Current `1.106.4`** — Paid agile remaining-points burndown. Paid schedule freeze baseline. Weekly next-week plan + independent monthly template. Free `lanpm.backup` (default on). License [AGPL-3.0-or-later](./LICENSE).
