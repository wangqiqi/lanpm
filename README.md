...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.4-blue" alt="version" />
...
**Current `1.78.4`** — Meeting compact toolbar UX; command invoke handlers; global plugin slots; offline licenses. License [AGPL-3.0-or-later](./LICENSE).
