...
**Current:** `1.0.0-rc.79` — M0–M7 closed in automation; **`verify:m7` green ≠ every PRD P0 item ≠ 1.0.0 ship gate**. See [acceptance plan](./docs/06_验收与里程碑计划.md) §2. Licensed under [AGPL-3.0-or-later](./LICENSE).
