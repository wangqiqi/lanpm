...
**Current:** `1.30.1` — **Meeting plugin SPIKE**: Lite mesh vs LiveKit Pro architecture, Host media slots/capabilities, `verify:meeting-spike` · prior **1.30.0** executive cockpit. M0–M7 closed in automation; true-device hand tests still deferred ([06_ROADMAP](./docs/06_ROADMAP.md) §4). License: [AGPL-3.0-or-later](./LICENSE).
