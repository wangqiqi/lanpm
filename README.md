...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.7-blue" alt="version" />
...
**Current `1.78.7`** — Per-group nav preferences (`NavPreferencesDocument`); Extension API v0.3. License [AGPL-3.0-or-later](./LICENSE).
