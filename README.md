...
| **Org & UX** | Project / functional / anonymous groups, leadership cockpit, light/dark, **zh / en**. Optional **weekly plugin** (`lanpm.weekly`, paid): license-gated weekly/monthly Markdown export. Optional **backup plugin** (`lanpm.backup`, free, **on by default**): encrypted single-group `.lanpm-bundle` in Profile; turn the plugin off to hide the section |
