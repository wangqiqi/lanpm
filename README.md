...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.80.0-blue" alt="version" />
...
**Current `1.80.0`** — Extension API v0.4 human-reviewed writes (`task.create`); chat context v2 (1.79.x). License [AGPL-3.0-or-later](./LICENSE).
