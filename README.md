...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.51.0-blue" alt="version" />
...
**Current `1.51.0`** — VirtualLan fault injection (UDP drop/delay, TCP-only fallback, rate-limit sim). License [AGPL-3.0-or-later](./LICENSE).
