...
**Current:** `1.13.0` — task acceptance checklist (P1-3, schema v9: detail CRUD, progress, create subtask from item), plus prior whiteboard / message↔task / calendar / tags / Presence. M0–M7 closed in automation; true-device hand tests still deferred (see [acceptance plan](./docs/06_验收与里程碑计划.md) §2.6). Licensed under [AGPL-3.0-or-later](./LICENSE).
