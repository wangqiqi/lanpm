...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.78.5-blue" alt="version" />
...
**Current `1.78.5`** — ViewHost zone context; chat toolbar single-path wiring; island chat layout fix. License [AGPL-3.0-or-later](./LICENSE).
