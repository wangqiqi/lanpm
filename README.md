...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.106.4-blue" alt="version" />
...
**Current `1.106.4`** — Paid schedule: freeze baseline + assignee date-overlap hints. Paid agile remaining-points burndown. Weekly next-week plan + independent monthly template. Free `lanpm.backup` (default on). License [AGPL-3.0-or-later](./LICENSE).
