...
**Current `1.55.0`** — Discover join-path UX simplification (Segmented share/join, auto-join single group, zero-group onboarding). License [AGPL-3.0-or-later](./LICENSE).
