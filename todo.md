...
| V-14b-GNT | 甘特修复后复截确认 | AUTO-20 空态 OK；排期任务条需 `dev` 内手验 | [ ] |
...
| — | 性能手测填表 | AUTO-15 m7-perf ✅（数值已归档，表项待勾） | [ ] |
| DOC-ACC-04 | I18N-05 英文 UI 走查 | AUTO-02 `verify:i18n-keys` ✅；长文案折行人工 | [ ] |
...
| — | `RootErrorBoundary` / 启动页残余硬编码色 | VIS-05 已跟主题；抽检无刺眼即可 | [ ] |
...
| DOC-F-04 | P3 | 顶栏 Profile 面板 disabled 抽检 | `TopBar` |
