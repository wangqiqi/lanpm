...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.0.6-blue" alt="version" />
...
**当前版本：** `1.0.6`（M0–M7 自动化已闭环）。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [验收计划](./docs/06_验收与里程碑计划.md) §2.6。
