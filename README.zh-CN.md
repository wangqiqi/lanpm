...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.33.4-blue" alt="version" />
...
**当前版本：** `1.33.4` — README/`verify:project` 同步 · `verify:m6` 动态端口；**onekey** 菜单精简 + 预检；**驾驶舱密度手风琴**（CK-410–415）。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [06_ROADMAP](./docs/06_ROADMAP.md) §4。
