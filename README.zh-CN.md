...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.31.0-blue" alt="version" />
...
**当前版本：** `1.31.0` — **驾驶舱领导视图**（CK-401–409）：滚动契约 · 执行摘要 · 需关注任务 · 部门完成率 · 文档 SSOT；此前 **视觉抛光 II**（VP-401–407）。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [06_ROADMAP](./docs/06_ROADMAP.md) §4。
