...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.103.1-blue" alt="version" />
...
**当前版本 `1.103.1`** — 群标签离线补拉、pdf.js 预览、minisearch、file_chunk `envelope_bin`。许可 [AGPL-3.0-or-later](./LICENSE)。
