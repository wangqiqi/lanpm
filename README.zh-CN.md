...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.80.0-blue" alt="version" />
...
**当前版本 `1.80.0`** — Extension API v0.4 写操作人审（`task.create`）；聊天进阶交互 v1.79.x。许可 [AGPL-3.0-or-later](./LICENSE)。
