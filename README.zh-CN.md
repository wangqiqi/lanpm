...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.4.0-blue" alt="version" />
...
| 规划 | Yjs `task_crdt`（**v1.1.0**）· P2P 续传（**v1.2.0**）· 看板标签（**v1.3.0**）· 焦点 Presence（**v1.4.0**）· WebRTC · IndexedDB 热缓存（post-RC） |
...
**当前版本：** `1.4.0`（任务焦点 Presence；筛选/字典/caret 待 `/release`）。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [验收计划](./docs/06_验收与里程碑计划.md) §2.6。
