...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.32.0-blue" alt="version" />
...
**当前版本：** `1.32.0` — **驾驶舱领导视图**（CK-401–409）+ **视觉抛光 II** 收尾（VP-404–407）。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [06_ROADMAP](./docs/06_ROADMAP.md) §4。
