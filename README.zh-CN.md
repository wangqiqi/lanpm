...
**当前版本：** `1.31.0` — **设计令牌 SSOT**（VP-401 首批）+ **Super Cursor** 工作流同步 · 含 **1.30.1** 会议 SPIKE · **1.30.0** 驾驶舱。许可：[AGPL-3.0-or-later](./LICENSE)。真机手验仍延期，见 [06_ROADMAP](./docs/06_ROADMAP.md) §4。
